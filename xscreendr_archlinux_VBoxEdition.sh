...
menu()
  {
    ...
    echo""
    echo -e "                            \e[31m                         Estado en BETA v5.0\e[0m"
    echo""
...
submenu_apply()
  ...
  {
    echo ""
    echo "1) Crear para Virtual-1"
    echo "2) Crear para Virtual-2"
    echo "3) Crear para Virtual-3"
    echo "4) Volver al menú principal"
    echo ""
  }
...
until [ "$opc" -eq 5 ]
  do
    case "$opc" in
      1)
        seleccion
        echo -e "Ejemplo: \e[31m1920 1080 60.00 (Sin espacios de más)\e[0m"
        echo ""
        creation=""
        read creation
